...
down_revision: Union[str, None] = "5bdba41590e5"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

TENANT_TABLES = ["users", "endpoints", "security_events", "alerts", "incidents",
                 "investigations", "audit_logs", "integration_accounts",
                 "integration_checkpoints", "dead_letter_events"]
