...
def upgrade() -> None:
    ...
    op.create_index('ix_endpoints_org_status', 'endpoints', ['organization_id', 'status'], unique=False)
    op.create_index(op.f('ix_endpoints_organization_id'), 'endpoints', ['organization_id'], unique=False)
    ...
    op.create_index('ix_events_org_occurred', 'security_events', ['organization_id', 'occurred_at'], unique=False)
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint('(alert_id IS NOT NULL AND incident_id IS NULL) OR (alert_id IS NULL AND incident_id IS NOT NULL)', name='ck_investigation_single_subject'),
